...
@section('content')
    <div class="bg-slate-950 text-slate-100 antialiased selection:bg-indigo-500/30">
                ...
                <section class="grid items-center gap-12 lg:grid-cols-[1.1fr_0.9fr]">
                    <div>
                        ...
                        <div class="mt-8 flex flex-wrap items-center gap-4">
                            <a href="#tarifs" class="inline-flex items-center gap-2 rounded-full bg-indigo-500 px-6 py-3.5 text-base font-semibold text-white shadow-xl shadow-indigo-500/30 transition hover:bg-indigo-400">
                                Essai gratuit
                            ...
                            <a href="#fonctionnalites" class="inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/5 px-6 py-3.5 text-base font-semibold text-slate-100 transition hover:border-white/30 hover:bg-white/10">
        ...
        <!-- ============================================================ -->
<!-- SECTION TARIFS (OFFRES) AVEC AFFICHAGE RESPONSIVE             -->
<!-- ============================================================ -->
<section id="tarifs" class="mt-24">
    ...
    {{-- AFFICHAGE : sur mobile → vertical, sur grand écran → horizontal --}}
...
<section id="temoignages" class="mt-24">
    ...
    <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        ...
        <div class="rounded-[2rem] border border-white/10 bg-white/5 p-6 backdrop-blur-sm hover:border-indigo-400/30 transition duration-300">
            <div class="flex items-center gap-3">
                <div class="flex h-12 w-12 items-center justify-center rounded-full bg-gradient-to-br from-indigo-500 to-emerald-400 text-lg font-bold text-white">
                    A
                </div>
                <div>
        ...
        <div class="rounded-[2rem] border border-white/10 bg-white/5 p-6 backdrop-blur-sm hover:border-indigo-400/30 transition duration-300">
            <div class="flex items-center gap-3">
                <div class="flex h-12 w-12 items-center justify-center rounded-full bg-gradient-to-br from-emerald-500 to-teal-400 text-lg font-bold text-white">
                    K
                </div>
                <div>
        ...
        <div class="rounded-[2rem] border border-white/10 bg-white/5 p-6 backdrop-blur-sm hover:border-indigo-400/30 transition duration-300">
            <div class="flex items-center gap-3">
                <div class="flex h-12 w-12 items-center justify-center rounded-full bg-gradient-to-br from-amber-400 to-orange-500 text-lg font-bold text-white">
                    M
                </div>
                <div>
